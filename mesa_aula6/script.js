...
let divPantera = document.createElement('div');
let divJaguar = document.createElement('div');
let divGuepardo = document.createElement('div');
...
function ativar(){
    ...
    container.appendChild(divLeopardo);
    container.appendChild(divPantera);
    container.appendChild(divJaguar);
    container.appendChild(divGuepardo);
}
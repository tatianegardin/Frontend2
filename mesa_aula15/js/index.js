...
.then(
        function renderizarDadosUsuario(dados) {
            ...
            console.log('rodou')
            console.log(dados.nome.primeiro)
            console.log(dados.nome.ultimo)
            console.log(dados.imagem.media)
            console.log(dados.email)

            div.innerHTML = `            
            <h3>${dados.nome.primeiro} ${dados.nome.ultimo}</h3>
            <p>Email: ${dados.email}</p>
            <img src="${dados.imagem.media}" alt="">`
